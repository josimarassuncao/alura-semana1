...
(def default-list [{
                   ...
                   {
                    :customer-id 411, :order-id 765920,
                    :bought_at "2021-05-12", :total-price 59.99,
                    :establishment "Mercado D'Avó", :category "Market",
                    :payment {:by "CC" :ref 1534 }
                    },
                   {
                    :customer-id 411, :order-id 135425,
